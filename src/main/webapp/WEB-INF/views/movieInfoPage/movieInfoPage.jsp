		...
		<div class="main">
			<div class="info_main_mid">
		        ...
		        <div class="info_main_mid_mid info_main_mid_box">
		          <div class="info_main_mid_mid_title txt">
		            극장판 귀멸의 칼날 무한열차편
		          </div>
		          <div class="info_main_mid_mid_contents">
		            <span class="movie_info_main txt">2020•애니메이션•일본</span><br>
		            <span class="movie_info_opendate textdeco txt">개봉일 : 2021-01-27 누적관객 : 1만명</span><br>
		            <span class="movie_info_score textdeco txt">평균 ★ 4.4(1,831명)</span>
		          </div>
		        </div>
		        <div class="info_main_mid_right info_main_mid_box">
		          ...
		          <form class="info_main_mid_right">
		            <button class="form-btn inp_btn">+보고싶어요</button>
		          </form>
		        </div>
			</div>
...
달리는 무한열차에서 승객들이 하나 둘 흔적 없이 사라지자 숨어있는 식인 혈귀의 존재를 직감하는 ‘렌고쿠’. 귀살대 ‘탄지로’ 일행과 최강 검사 염주 ‘렌고쿠’는 어둠 속을 달리는 무한열차에서 모두의 목숨을 구하기 위해 예측불가능한 능력을 가진 혈귀와 목숨을 건 혈전을 시작하는데…
				...
				<div class="info_main_bot_staff">
					<div class="info_main_bot_staff_font txt">출연 / 제작</div>
					<!-- 구분선 출연/제작 1 -->
