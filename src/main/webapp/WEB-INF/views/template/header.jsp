			...
			<div class="main-template-header animated fadeInDown">
				...
				<div class="main-header-link-box">
					<span class="recommend-link">
						<a href="#"	class="recommend-link-a"> 추천 받기 </a>
					</span>
					<span class="category-link">
						<a href="request_list_page.do" class="category-link-a"> 장르별 </a>
					</span>
					<span class="faq-link">
						<a href="request_list_page.do" class="faq-link-a"> 문의 하기 </a>
					</span>
				</div>
		...
		<div class="top-wrap">
			...
			<div class="main-template-header animated fadeInDown">
				...
				<div class="login-search-box">
					...
					<span class="user-btn">
						<i class="fas fa-user-circle fa-3x" onclick="location.href='loginPage.do'"></i>
					</span>
				</div>
			</div>
		</div>
