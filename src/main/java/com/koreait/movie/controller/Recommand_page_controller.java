...
import com.koreait.movie.command.recommand.Recommand_randomMovieCommand;
...
public class Recommand_page_controller {
	...
	private Recommand_randomMovieCommand randomMovieCommand;
	private RecommandSituMovieCommand situMovieCommand;
	
	@Autowired
	public void setBean(Recommand_randomMovieCommand randomMovieCommand, RecommandSituMovieCommand situMovieCommand) {
